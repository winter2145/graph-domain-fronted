...
const getVerifyCode = async () => {
  ...
  if (res.data.code === 0 && res.data.data) {
    ...
    formState.serverIfCode = res.data.data.encryptedCaptcha
  }
}
...
const handleSubmit = async (values: any) => {
  ...
  values.serverIfCode = formState.serverIfCode
  ...
  if (res.data.code === 0 && res.data.data) {
    ...
    const safePath = getSafeRedirectPath(redirectUrl, '/home')
