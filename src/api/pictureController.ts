...
/** incrementViewCountEndpoint GET /api/picture/increment/viewCount */
export async function incrementViewCountAPI(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: { pictureId: string | number },
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/picture/increment/viewCount', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listMyPictureVoByPageUsingPost(
  ...
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/my/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getTop10PictureUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getTop10PictureUsingGETParams,
  options?: { [key: string]: any }
) {
  const { id: param0, ...queryParams } = params
  return request<API.BaseResponseListPictureVO_>(`/api/picture/top10/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
