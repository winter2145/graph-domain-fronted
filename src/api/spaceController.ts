...
/** listCreatedSpaceVOByPage POST /api/space/list/page/created */
export async function listCreatedSpaceVoByPageUsingPost(
  body: API.SpaceQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponse>('/api/space/list/page/created', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
